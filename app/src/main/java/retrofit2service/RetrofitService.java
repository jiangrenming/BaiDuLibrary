...
import retrofit2service.api.BaiDuApi;
import retrofit2service.api.GithubApi;
...
public class RetrofitService extends Retrofit2Client {
   ...
   private Handler retroHandle;
    ...
    public RetrofitService(){
        ...
        baiDuApi = retrofitBuilder.baseUrl(BaiDuApi.BASE_URL).build().create(BaiDuApi.class);
   ...
   /* *
     ...
     * @param params
     */
    public void postAppInfoMapParamsBiadu(final MyCallBack myCallBack,Map<String,String > params){
        baiDuApi.createBaiduData(params).enqueue(new Callback<Object>() {
            @Override
            public void onResponse(final Call<Object> call, final Response<Object> response) {
                retroHandle.post(new Runnable() {
                    @Override
